package com.clawp.android.tool

import com.clawp.android.tool.impl.*
import com.clawp.android.tool.impl.mobile.*
import com.clawp.android.tool.impl.tv.*
...
object ToolRegistry {
    ...
    private fun registerMobileTools() {
        ...
        register(ClickElementByTextTool())
        register(WaitForElementTool())
        register(DismissSystemDialogTool())
    }
